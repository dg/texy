 ...
 * @package    Texy
 * @category   Text
 * @version    1.1b for PHP4 & PHP5 $Date: 2007-02-12 15:26:17 +0100 (po, 12 II 2007) $ $Revision: 50 $
 */if(version_compare(PHP_VERSION,'4.3.3','<'))die('Texy!: too old version of PHP!');define('TEXY','Version 1.1b for PHP4 & PHP5 $Revision: 50 $');define('TEXY_DIR',dirname(__FILE__).'/');
