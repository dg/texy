...
| `Syntax::LinkDefinition` | LinkReferenceModule | `LinkDefinitionNode` | `[nette]: https://...` | (definice) |
...
| `Syntax::Hyphenation` | HyphenationModule | Dělení dlouhých slov měkkými spojovníky |
