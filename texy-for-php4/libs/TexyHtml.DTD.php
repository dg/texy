...
function TexyHtml_initDTD($strict)
{
// attributes
...
$GLOBALS['TexyHtml::$dtd']['a'][0] += array('target'=>1);
$GLOBALS['TexyHtml::$dtd']['area'][0] += array('target'=>1);
$GLOBALS['TexyHtml::$dtd']['body'][0] += array('background'=>1,'bgcolor'=>1,'text'=>1,'link'=>1,'vlink'=>1,'alink'=>1);
$GLOBALS['TexyHtml::$dtd']['form'][0] += array('target'=>1);
$GLOBALS['TexyHtml::$dtd']['img'][0] += array('align'=>1,'border'=>1,'hspace'=>1,'vspace'=>1);
$GLOBALS['TexyHtml::$dtd']['input'][0] += array('align'=>1);
$GLOBALS['TexyHtml::$dtd']['link'][0] += array('target'=>1);
$GLOBALS['TexyHtml::$dtd']['object'][0] += array('align'=>1,'border'=>1,'hspace'=>1,'vspace'=>1);
$GLOBALS['TexyHtml::$dtd']['script'][0] += array('language'=>1);
$GLOBALS['TexyHtml::$dtd']['table'][0] += array('align'=>1,'bgcolor'=>1);
$GLOBALS['TexyHtml::$dtd']['td'][0] += array('nowrap'=>1,'bgcolor'=>1,'width'=>1,'height'=>1);
$GLOBALS['TexyHtml::$dtd']['th'][0] += array('nowrap'=>1,'bgcolor'=>1,'width'=>1,'height'=>1);
